...
import {
    ...
    deleteCalculatorCategory, deleteCalculatorInputs, deleteUsersCalculator, getCalculatorCategories, getUserByEmail,
                ...
                <div>
                    ...
                    >
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant={modalVariantColor}
                                    onClick={() => isSaveHandler ? handleSave() : handleDelete()}>{modalBtnMessage}</Button>
                        </Modal.Footer>
                    </Modal>
                </div>
            )}

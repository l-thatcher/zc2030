...
const ShowWallet = () => {
    ...
    const logo = "/cz2030_logo.png";
    console.log(session.user.publicAddress)
            ...
            <>
                    ...
                    <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                        <div className="relative">
                            <div className="bg-white w-40 -mt-20 border rounded-full ">
                                <Image className='w-96' src={session.user.image} alt="Profile picture" raised rounded/>
                            </div>
                        </div>
                    </div>

                    <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:self-center flex justify-center mt-10 lg:justify-end lg:mt-0">
                        <button className="btn border-blue-500 " type="button"><Icon size="lg" /> Settings</button>
                    </div>
                ...
                <div className="text-center my-8">
                    ...
                    <div className="mt-0 mb-2 text-gray-700  flex items-center justify-center gap-2">
                        ...
                        <span className='text-tahiti truncate ... text-cyan-400 '><Link href={"https://etherscan.io/address/0x"+session.user.publicAddress}>
                  <a  target="_blank" className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="#"
                  >0x{session.user.publicAddress}r</a>
                </Link> </span>
                    </div>
                </div>

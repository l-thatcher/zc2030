        ...
        <>
            ...
            <div className="text-center my-8">
                ...
                <div className="mt-0 mb-2 text-gray-700  flex items-center justify-center gap-2">
                    ...
                    <span className='text-tahiti truncate ... text-cyan-400 '><Link
                        href={"https://etherscan.io/address/0x" + session.user.publicAddress}>
                  <a target="_blank" className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0"
                     href="#"

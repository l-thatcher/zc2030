...
test('Should render CarbonCalculator component with [0] data and identifies category names', () => {
    ...
    render(<CarbonCalculator data={data[0].name} id={data[0].id} category={data[0].category} results={data[0].results}/>)
    ...
    expect(calculatorHeading).toHaveTextContent('Individual Calculator');
...
test('Should render CarbonCalculator component with [4] data and identifies category names', () => {
    ...
    render(<CarbonCalculator data={data[4].name} id={data[4].id} category={data[4].category} results={data[4].results}/>)
    ...
    // Identifies calculator heading, checks its content and is visible
    expect(calculatorHeading).toBeInTheDocument();
    expect(calculatorHeading).toHaveTextContent('University Calculator');
    expect(calculatorHeading).toBeVisible();
...
test('Should render calculator component and find main heading and button', () => {
    ...
    render(<CarbonCalculator data={data[1].name} id={data[1].id} category={data[1].category} results={data[1].results}/>)

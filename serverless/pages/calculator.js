  ...
  return (
    <div className={styles.container}>
      <div className='pt-32 sm:pt-0'>
        <svg className='absolute w-full h-5/6 z-0' id="visual" viewBox="0 0 900 600" width="900" height="600" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" version="1.1">

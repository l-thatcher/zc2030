describe("Navigation", () => {
    it("should navigate to add calculator page and create a calculator", () => {
        ...
        // Press button
        cy.get("button#button-addon2.Calculator_buttonAdd__XjB51.btn.btn-outline-secondary.btn-md").click();

        // Find category and type value
        cy.get('input#category-name.form-control.form-control-lg').type("Category 1");
